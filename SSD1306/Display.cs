...
namespace SSD1306
{
    ...
    public class Display
    {
        ...
        public byte IICAddress { get; set; } = 0x3C;
               

        static public readonly byte DefaultI2CAddress = 0x3C;

        I2CPort.USB_ISS i2cDevice;

        bool DisplayStateOn = false;


        public Display(I2CPort.USB_ISS I2cDevice, uint WidthPx = 128, uint HeightPx = 32, bool flipDisplay = false)
        {
        ...
        private void SendDisplayData(byte[] Data)
        {
            ...
            i2cDevice.I2CWrite(IICAddress,40,Data); // aanpassen !!
        }
